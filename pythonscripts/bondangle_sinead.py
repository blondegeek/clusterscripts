...
#
bariums=[i for i in atoms if str(s[i].specie)=="Ba"]
magnesiums=[i for i in atoms if str(s[i].specie)=="Mn"]
arsenics=[i for i in atoms if str(s[i].specie)=="As"]
...
getDistinctLengths(magnesiums,arsenics,3.0,0.5,s,atomNumber,equiv)
...
getDistinctAngles(magnesiums,arsenics,3,0.5,s,atomNumber,equiv)
